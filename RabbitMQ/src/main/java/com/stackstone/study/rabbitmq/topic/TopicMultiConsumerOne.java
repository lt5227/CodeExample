 ...
 * @description: 消费者1
 */
public class TopicMultiConsumerOne {
    public static final String EXCHANGE_NAME = "rabbit:mq04:exchange:e01";

    public static final String QUEUE_NAME_01 = "rabbit:mq04:queue:q01";
    public static final String ROUTING_KEY_01 = "rabbit:mq04:routing:key:r.*";
